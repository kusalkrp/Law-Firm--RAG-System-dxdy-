...
class QueryRequest(BaseModel):
    question: str = Field(..., min_length=3, description="Legal question to ask across the contracts corpus")
    top_k: int = Field(default=5, ge=1, le=20, description="Number of top context chunks to retrieve")
    clause_filter: Optional[str] = Field(default=None, description="Optional advanced parameter for category-scoped filtering (None by default)")
